...
import { SideProjectCard } from "@/components/ui/side-project-card";
        ...
        <ScrollReveal>
          <div className="text-center mb-12">
            ...
            <p className="text-secondary dark:text-gray-400 max-w-2xl mx-auto">
              Open-source tools and personal projects I&apos;ve built to solve real problems.
        ...
        <ScrollReveal>
          <div className="text-center mt-12">
            <a
              ...
              className="inline-flex items-center gap-2 text-cta dark:text-blue-400 font-medium hover:underline transition-colors"
            >
